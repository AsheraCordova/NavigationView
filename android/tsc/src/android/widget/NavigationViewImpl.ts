...
export abstract class NavigationViewImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
    }	
	...
	@decorate(Type(() => CommandAttr))
	@decorate(Expose({ name: "itemTextAppearanceActiveBoldEnabled" }))
	itemTextAppearanceActiveBoldEnabled!:CommandAttr<boolean>| undefined;
	@decorate(Type(() => CommandAttr))
	...
	@decorate(Type(() => CommandAttr))
	@decorate(Expose({ name: "bottomInsetScrimEnabled" }))
	bottomInsetScrimEnabled!:CommandAttr<boolean>| undefined;
	@decorate(Type(() => CommandAttr))
	...
	@decorate(Type(() => CommandAttr))
	@decorate(Expose({ name: "topInsetScrimEnabled" }))
	topInsetScrimEnabled!:CommandAttr<boolean>| undefined;
	...
	reset() : T {	
		...
		this.topInsetScrimEnabled = undefined;
	...
	public setItemTextAppearanceActiveBoldEnabled(value : boolean) : T {
		this.resetIfRequired();
		if (this.itemTextAppearanceActiveBoldEnabled == null || this.itemTextAppearanceActiveBoldEnabled == undefined) {
			this.itemTextAppearanceActiveBoldEnabled = new CommandAttr<boolean>();
		}
		
		this.itemTextAppearanceActiveBoldEnabled.setSetter(true);
		this.itemTextAppearanceActiveBoldEnabled.setValue(value);
		this.orderSet++;
		this.itemTextAppearanceActiveBoldEnabled.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public setBottomInsetScrimEnabled(value : boolean) : T {
		this.resetIfRequired();
		if (this.bottomInsetScrimEnabled == null || this.bottomInsetScrimEnabled == undefined) {
			this.bottomInsetScrimEnabled = new CommandAttr<boolean>();
		}
		
		this.bottomInsetScrimEnabled.setSetter(true);
		this.bottomInsetScrimEnabled.setValue(value);
		this.orderSet++;
		this.bottomInsetScrimEnabled.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public setTopInsetScrimEnabled(value : boolean) : T {
		this.resetIfRequired();
		if (this.topInsetScrimEnabled == null || this.topInsetScrimEnabled == undefined) {
			this.topInsetScrimEnabled = new CommandAttr<boolean>();
		}
		
		this.topInsetScrimEnabled.setSetter(true);
		this.topInsetScrimEnabled.setValue(value);
		this.orderSet++;
		this.topInsetScrimEnabled.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
