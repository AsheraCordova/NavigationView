...
export abstract class BottomNavigationViewImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
    }	
	@decorate(Type(() => CommandAttr))
	@decorate(Expose({ name: "itemHorizontalTranslationEnabled" }))
	itemHorizontalTranslationEnabled!:CommandAttr<boolean>| undefined;
	@decorate(Type(() => CommandAttr))
	...
	@decorate(Type(() => CommandAttr))
	@decorate(Expose({ name: "itemRippleColor" }))
	itemRippleColor!:CommandAttr<string>| undefined;
	@decorate(Type(() => CommandAttr))
	...
	reset() : T {	
		super.reset();
		this.itemHorizontalTranslationEnabled = undefined;
		...
		this.itemRippleColor = undefined;
	...
	public setItemHorizontalTranslationEnabled(value : boolean) : T {
		this.resetIfRequired();
		if (this.itemHorizontalTranslationEnabled == null || this.itemHorizontalTranslationEnabled == undefined) {
			this.itemHorizontalTranslationEnabled = new CommandAttr<boolean>();
		}
		
		this.itemHorizontalTranslationEnabled.setSetter(true);
		this.itemHorizontalTranslationEnabled.setValue(value);
		this.orderSet++;
		this.itemHorizontalTranslationEnabled.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public setItemRippleColor(value : string) : T {
		this.resetIfRequired();
		if (this.itemRippleColor == null || this.itemRippleColor == undefined) {
			this.itemRippleColor = new CommandAttr<string>();
		}
		
		this.itemRippleColor.setSetter(true);
		this.itemRippleColor.setValue(value);
		this.orderSet++;
		this.itemRippleColor.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
...
export class BottomNavigationView extends BottomNavigationViewImpl<BottomNavigationView> implements IWidget{
    getThisPointer(): BottomNavigationView {
        return this;
    }
...
BottomNavigationViewImpl.initialize();
