...
__attribute__((unused)) static void ASBaselineLayoutImpl_nativeRemoveViewWithASIWidget_(ASBaselineLayoutImpl *self, id<ASIWidget> widget);

__attribute__((unused)) static void ASBaselineLayoutImpl_createLayoutParamsWithADView_(ASBaselineLayoutImpl *self, ADView *view);

__attribute__((unused)) static ADViewGroup_LayoutParams *ASBaselineLayoutImpl_getLayoutParamsWithADView_(ASBaselineLayoutImpl *self, ADView *view);

@interface ASBaselineLayoutImpl_BaselineLayoutExt () {
 @public
  WEAK_ ASBaselineLayoutImpl *this$0_;
...
J2OBJC_FIELD_SETTER(ASBaselineLayoutImpl_BaselineLayoutExt, measureFinished_, ASMeasureEvent *)
...
J2OBJC_EMPTY_STATIC_INIT(ASBaselineLayoutImpl_$Lambda$1)

__attribute__((unused)) static void ASBaselineLayoutImpl_$Lambda$1_initWithASIWidget_(ASBaselineLayoutImpl_$Lambda$1 *self, id<ASIWidget> capture$0);

__attribute__((unused)) static ASBaselineLayoutImpl_$Lambda$1 *new_ASBaselineLayoutImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ASBaselineLayoutImpl_$Lambda$1 *create_ASBaselineLayoutImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0);


NSString *ASBaselineLayoutImpl_LOCAL_NAME = @"com.google.android.material.internal.BaselineLayout";
NSString *ASBaselineLayoutImpl_GROUP_NAME = @"com.google.android.material.internal.BaselineLayout";

@implementation ASBaselineLayoutImpl
...
- (instancetype)init {
  ASBaselineLayoutImpl_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (instancetype)initWithNSString:(NSString *)localname {
  ASBaselineLayoutImpl_initWithNSString_(self, localname);
  return self;
}

- (instancetype)initWithNSString:(NSString *)groupName
                    withNSString:(NSString *)localname {
  ASBaselineLayoutImpl_initWithNSString_withNSString_(self, groupName, localname);
  return self;
}

- (id<ASIWidget>)newInstance {
  return new_ASBaselineLayoutImpl_initWithNSString_withNSString_(groupName_, localName_);
}

- (void)createWithASIFragment:(id<ASIFragment>)fragment
              withJavaUtilMap:(id<JavaUtilMap>)params {
  [super createWithASIFragment:fragment withJavaUtilMap:params];
  baselineLayout_ = new_ASBaselineLayoutImpl_BaselineLayoutExt_initWithASBaselineLayoutImpl_(self);
  [self nativeCreateWithJavaUtilMap:params];
  ASViewGroupImpl_registerCommandConveterWithASIWidget_(self);
  ASBaselineLayoutImpl_setWidgetOnNativeClass(self);
}
...
- (id)asWidget {
  return baselineLayout_;
}

- (bool)removeWithASIWidget:(id<ASIWidget>)w {
  bool remove = [super removeWithASIWidget:w];
  [((ADXBaselineLayout *) nil_chk(baselineLayout_)) removeViewWithADView:(ADView *) cast_chk([((id<ASIWidget>) nil_chk(w)) asWidget], [ADView class])];
  ASBaselineLayoutImpl_nativeRemoveViewWithASIWidget_(self, w);
  return remove;
}
...
- (bool)removeWithInt:(int32_t)index {
  ...
  if (index + 1 <= [((ADXBaselineLayout *) nil_chk(baselineLayout_)) getChildCount]) {
    [((ADXBaselineLayout *) nil_chk(baselineLayout_)) removeViewAtWithInt:index];
    ASBaselineLayoutImpl_nativeRemoveViewWithASIWidget_(self, widget);
  }
  return remove;
}
...
- (void)addWithASIWidget:(id<ASIWidget>)w
  ...
  if (index != -2) {
    ...
    ASBaselineLayoutImpl_createLayoutParamsWithADView_(self, view);
    if (index == -1) {
      [((ADXBaselineLayout *) nil_chk(baselineLayout_)) addViewWithADView:view];
    }
    else {
      [((ADXBaselineLayout *) nil_chk(baselineLayout_)) addViewWithADView:view withInt:index];
    }
  }
...
- (ADViewGroup_LayoutParams *)getLayoutParamsWithADView:(ADView *)view {
  return ASBaselineLayoutImpl_getLayoutParamsWithADView_(self, view);
}
...
- (void)setChildAttributeWithASIWidget:(id<ASIWidget>)w
                 withASWidgetAttribute:(ASWidgetAttribute *)key
                          withNSString:(NSString *)strValue
                                withId:(id)objValue {
  ADView *view = (ADView *) cast_chk([((id<ASIWidget>) nil_chk(w)) asWidget], [ADView class]);
  ADViewGroup_LayoutParams *layoutParams = ASBaselineLayoutImpl_getLayoutParamsWithADView_(self, view);
...
- (IOSClass *)getViewClass {
  return ASBaselineLayoutImpl_BaselineLayoutExt_class_();
}
...
- (void)setIdWithNSString:(NSString *)id_ {
  if (id_ != nil && ![id_ isEqual:@""]) {
    ...
    [((ADXBaselineLayout *) nil_chk(baselineLayout_)) setIdWithInt:[((JavaLangInteger *) nil_chk((JavaLangInteger *) cast_chk([self quickConvertWithId:id_ withNSString:@"id"], [JavaLangInteger class]))) intValue]];
  }
}
...
void ASBaselineLayoutImpl_init(ASBaselineLayoutImpl *self) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, ASBaselineLayoutImpl_GROUP_NAME, ASBaselineLayoutImpl_LOCAL_NAME);
}

ASBaselineLayoutImpl *new_ASBaselineLayoutImpl_init() {
  J2OBJC_NEW_IMPL(ASBaselineLayoutImpl, init)
}

ASBaselineLayoutImpl *create_ASBaselineLayoutImpl_init() {
  J2OBJC_CREATE_IMPL(ASBaselineLayoutImpl, init)
}

void ASBaselineLayoutImpl_initWithNSString_(ASBaselineLayoutImpl *self, NSString *localname) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, ASBaselineLayoutImpl_GROUP_NAME, localname);
}

ASBaselineLayoutImpl *new_ASBaselineLayoutImpl_initWithNSString_(NSString *localname) {
  J2OBJC_NEW_IMPL(ASBaselineLayoutImpl, initWithNSString_, localname)
}

ASBaselineLayoutImpl *create_ASBaselineLayoutImpl_initWithNSString_(NSString *localname) {
  J2OBJC_CREATE_IMPL(ASBaselineLayoutImpl, initWithNSString_, localname)
}

void ASBaselineLayoutImpl_initWithNSString_withNSString_(ASBaselineLayoutImpl *self, NSString *groupName, NSString *localname) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, groupName, localname);
}

ASBaselineLayoutImpl *new_ASBaselineLayoutImpl_initWithNSString_withNSString_(NSString *groupName, NSString *localname) {
  J2OBJC_NEW_IMPL(ASBaselineLayoutImpl, initWithNSString_withNSString_, groupName, localname)
}

ASBaselineLayoutImpl *create_ASBaselineLayoutImpl_initWithNSString_withNSString_(NSString *groupName, NSString *localname) {
  J2OBJC_CREATE_IMPL(ASBaselineLayoutImpl, initWithNSString_withNSString_, groupName, localname)
}

void ASBaselineLayoutImpl_setWidgetOnNativeClass(ASBaselineLayoutImpl *self) {
  ((ASUIView*) [self asNativeWidget]).widget = self;
}

void ASBaselineLayoutImpl_nativeRemoveViewWithASIWidget_(ASBaselineLayoutImpl *self, id<ASIWidget> widget) {
  ADLayoutTransition *layoutTransition = [((ADXBaselineLayout *) nil_chk(self->baselineLayout_)) getLayoutTransition];
  if (layoutTransition != nil && ([layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_CHANGE_DISAPPEARING] || [layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_DISAPPEARING])) {
    [self addToBufferedRunnablesWithJavaLangRunnable:new_ASBaselineLayoutImpl_$Lambda$1_initWithASIWidget_(widget)];
  }
  else {
...
void ASBaselineLayoutImpl_createLayoutParamsWithADView_(ASBaselineLayoutImpl *self, ADView *view) {
...
ADViewGroup_LayoutParams *ASBaselineLayoutImpl_getLayoutParamsWithADView_(ASBaselineLayoutImpl *self, ADView *view) {
  return [((ADView *) nil_chk(view)) getLayoutParams];
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ASBaselineLayoutImpl)

J2OBJC_NAME_MAPPING(ASBaselineLayoutImpl, "com.ashera.navigationview", "AS")

@implementation ASBaselineLayoutImpl_BaselineLayoutExt
...
- (instancetype)initWithASBaselineLayoutImpl:(ASBaselineLayoutImpl *)outer$ {
  ASBaselineLayoutImpl_BaselineLayoutExt_initWithASBaselineLayoutImpl_(self, outer$);
  return self;
}
...
- (void)__javaClone:(ASBaselineLayoutImpl_BaselineLayoutExt *)original {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(initWithASBaselineLayoutImpl:);
  ...
  static const void *ptrTable[] = { "setMaxWidth", "I", "setMaxHeight", "LASBaselineLayoutImpl;", "onMeasure", "II", "onLayout", "ZIIII", "execute", "LNSString;[LNSObject;", "updateMeasuredDimension", "newInstance", "LASIWidget;", "setAttribute", "LASWidgetAttribute;LNSString;LNSObject;", "()Ljava/util/List<Ljava/lang/String;>;", "getAttribute", "LASWidgetAttribute;", "inflateView", "LNSString;", "getLocationOnScreen", "[I", "getWindowVisibleDisplayFrame", "LADRect;", "offsetTopAndBottom", "offsetLeftAndRight", "setMyAttribute", "LNSString;LNSObject;", "setVisibility", "setState0", "LNSObject;", "setState1", "setState2", "setState3", "setState4", "endViewTransition", "LADView;", "Ljava/util/List<Lcom/ashera/widget/IWidget;>;", "Ljava/util/Map<Ljava/lang/String;Lcom/ashera/widget/IWidget;>;" };
  static const J2ObjcClassInfo _ASBaselineLayoutImpl_BaselineLayoutExt = { "BaselineLayoutExt", "com.ashera.navigationview", ptrTable, methods, fields, 7, 0x1, 38, 7, 3, -1, -1, -1, -1 };
  return &_ASBaselineLayoutImpl_BaselineLayoutExt;
}

@end

void ASBaselineLayoutImpl_BaselineLayoutExt_initWithASBaselineLayoutImpl_(ASBaselineLayoutImpl_BaselineLayoutExt *self, ASBaselineLayoutImpl *outer$) {
  self->this$0_ = outer$;
...
ASBaselineLayoutImpl_BaselineLayoutExt *new_ASBaselineLayoutImpl_BaselineLayoutExt_initWithASBaselineLayoutImpl_(ASBaselineLayoutImpl *outer$) {
  J2OBJC_NEW_IMPL(ASBaselineLayoutImpl_BaselineLayoutExt, initWithASBaselineLayoutImpl_, outer$)
}

ASBaselineLayoutImpl_BaselineLayoutExt *create_ASBaselineLayoutImpl_BaselineLayoutExt_initWithASBaselineLayoutImpl_(ASBaselineLayoutImpl *outer$) {
  J2OBJC_CREATE_IMPL(ASBaselineLayoutImpl_BaselineLayoutExt, initWithASBaselineLayoutImpl_, outer$)
}
...
void ASBaselineLayoutImpl_$Lambda$1_initWithASIWidget_(ASBaselineLayoutImpl_$Lambda$1 *self, id<ASIWidget> capture$0) {
  self->val$widget_ = capture$0;
  NSObject_init(self);
}

ASBaselineLayoutImpl_$Lambda$1 *new_ASBaselineLayoutImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_NEW_IMPL(ASBaselineLayoutImpl_$Lambda$1, initWithASIWidget_, capture$0)
}

ASBaselineLayoutImpl_$Lambda$1 *create_ASBaselineLayoutImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_CREATE_IMPL(ASBaselineLayoutImpl_$Lambda$1, initWithASIWidget_, capture$0)
}
