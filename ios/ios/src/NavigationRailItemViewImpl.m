...
__attribute__((unused)) static void ASNavigationRailItemViewImpl_nativeRemoveViewWithASIWidget_(ASNavigationRailItemViewImpl *self, id<ASIWidget> widget);

__attribute__((unused)) static void ASNavigationRailItemViewImpl_createLayoutParamsWithADView_(ASNavigationRailItemViewImpl *self, ADView *view);

__attribute__((unused)) static ADFrameLayout_LayoutParams *ASNavigationRailItemViewImpl_getLayoutParamsWithADView_(ASNavigationRailItemViewImpl *self, ADView *view);

@interface ASNavigationRailItemViewImpl_NavigationRailItemViewExt () {
 @public
  WEAK_ ASNavigationRailItemViewImpl *this$0_;
...
J2OBJC_FIELD_SETTER(ASNavigationRailItemViewImpl_NavigationRailItemViewExt, measureFinished_, ASMeasureEvent *)
...
J2OBJC_EMPTY_STATIC_INIT(ASNavigationRailItemViewImpl_$Lambda$1)

__attribute__((unused)) static void ASNavigationRailItemViewImpl_$Lambda$1_initWithASIWidget_(ASNavigationRailItemViewImpl_$Lambda$1 *self, id<ASIWidget> capture$0);

__attribute__((unused)) static ASNavigationRailItemViewImpl_$Lambda$1 *new_ASNavigationRailItemViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ASNavigationRailItemViewImpl_$Lambda$1 *create_ASNavigationRailItemViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0);


NSString *ASNavigationRailItemViewImpl_LOCAL_NAME = @"com.google.android.material.navigationrail.NavigationRailItemView";
NSString *ASNavigationRailItemViewImpl_GROUP_NAME = @"com.google.android.material.navigationrail.NavigationRailItemView";

@implementation ASNavigationRailItemViewImpl
...
- (instancetype)init {
  ASNavigationRailItemViewImpl_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (instancetype)initWithNSString:(NSString *)localname {
  ASNavigationRailItemViewImpl_initWithNSString_(self, localname);
  return self;
}

- (instancetype)initWithNSString:(NSString *)groupName
                    withNSString:(NSString *)localname {
  ASNavigationRailItemViewImpl_initWithNSString_withNSString_(self, groupName, localname);
  return self;
}

- (id<ASIWidget>)newInstance {
  return new_ASNavigationRailItemViewImpl_initWithNSString_withNSString_(groupName_, localName_);
}

- (void)createWithASIFragment:(id<ASIFragment>)fragment
              withJavaUtilMap:(id<JavaUtilMap>)params {
  [super createWithASIFragment:fragment withJavaUtilMap:params];
  navigationRailItemView_ = new_ASNavigationRailItemViewImpl_NavigationRailItemViewExt_initWithASNavigationRailItemViewImpl_(self);
  [self nativeCreateWithJavaUtilMap:params];
  ASViewGroupImpl_registerCommandConveterWithASIWidget_(self);
  ASNavigationRailItemViewImpl_setWidgetOnNativeClass(self);
}
...
- (id)asWidget {
  return navigationRailItemView_;
}

- (bool)removeWithASIWidget:(id<ASIWidget>)w {
  bool remove = [super removeWithASIWidget:w];
  [((ADXNavigationRailItemView *) nil_chk(navigationRailItemView_)) removeViewWithADView:(ADView *) cast_chk([((id<ASIWidget>) nil_chk(w)) asWidget], [ADView class])];
  ASNavigationRailItemViewImpl_nativeRemoveViewWithASIWidget_(self, w);
  return remove;
}
...
- (bool)removeWithInt:(int32_t)index {
  ...
  if (index + 1 <= [((ADXNavigationRailItemView *) nil_chk(navigationRailItemView_)) getChildCount]) {
    [((ADXNavigationRailItemView *) nil_chk(navigationRailItemView_)) removeViewAtWithInt:index];
    ASNavigationRailItemViewImpl_nativeRemoveViewWithASIWidget_(self, widget);
  }
  return remove;
}
...
- (void)addWithASIWidget:(id<ASIWidget>)w
  ...
  if (index != -2) {
    ...
    ASNavigationRailItemViewImpl_createLayoutParamsWithADView_(self, view);
    if (index == -1) {
      [((ADXNavigationRailItemView *) nil_chk(navigationRailItemView_)) addViewWithADView:view];
    }
    else {
      [((ADXNavigationRailItemView *) nil_chk(navigationRailItemView_)) addViewWithADView:view withInt:index];
    }
  }
...
- (ADFrameLayout_LayoutParams *)getLayoutParamsWithADView:(ADView *)view {
  return ASNavigationRailItemViewImpl_getLayoutParamsWithADView_(self, view);
}
...
- (void)setChildAttributeWithASIWidget:(id<ASIWidget>)w
                 withASWidgetAttribute:(ASWidgetAttribute *)key
                          withNSString:(NSString *)strValue
                                withId:(id)objValue {
  ADView *view = (ADView *) cast_chk([((id<ASIWidget>) nil_chk(w)) asWidget], [ADView class]);
  ADFrameLayout_LayoutParams *layoutParams = ASNavigationRailItemViewImpl_getLayoutParamsWithADView_(self, view);
...
- (IOSClass *)getViewClass {
  return ASNavigationRailItemViewImpl_NavigationRailItemViewExt_class_();
}
...
- (void)setIdWithNSString:(NSString *)id_ {
  if (id_ != nil && ![id_ isEqual:@""]) {
    ...
    [((ADXNavigationRailItemView *) nil_chk(navigationRailItemView_)) setIdWithInt:[((JavaLangInteger *) nil_chk((JavaLangInteger *) cast_chk([self quickConvertWithId:id_ withNSString:@"id"], [JavaLangInteger class]))) intValue]];
  }
}
...
void ASNavigationRailItemViewImpl_init(ASNavigationRailItemViewImpl *self) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, ASNavigationRailItemViewImpl_GROUP_NAME, ASNavigationRailItemViewImpl_LOCAL_NAME);
}

ASNavigationRailItemViewImpl *new_ASNavigationRailItemViewImpl_init() {
  J2OBJC_NEW_IMPL(ASNavigationRailItemViewImpl, init)
}

ASNavigationRailItemViewImpl *create_ASNavigationRailItemViewImpl_init() {
  J2OBJC_CREATE_IMPL(ASNavigationRailItemViewImpl, init)
}

void ASNavigationRailItemViewImpl_initWithNSString_(ASNavigationRailItemViewImpl *self, NSString *localname) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, ASNavigationRailItemViewImpl_GROUP_NAME, localname);
}

ASNavigationRailItemViewImpl *new_ASNavigationRailItemViewImpl_initWithNSString_(NSString *localname) {
  J2OBJC_NEW_IMPL(ASNavigationRailItemViewImpl, initWithNSString_, localname)
}

ASNavigationRailItemViewImpl *create_ASNavigationRailItemViewImpl_initWithNSString_(NSString *localname) {
  J2OBJC_CREATE_IMPL(ASNavigationRailItemViewImpl, initWithNSString_, localname)
}

void ASNavigationRailItemViewImpl_initWithNSString_withNSString_(ASNavigationRailItemViewImpl *self, NSString *groupName, NSString *localname) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, groupName, localname);
}

ASNavigationRailItemViewImpl *new_ASNavigationRailItemViewImpl_initWithNSString_withNSString_(NSString *groupName, NSString *localname) {
  J2OBJC_NEW_IMPL(ASNavigationRailItemViewImpl, initWithNSString_withNSString_, groupName, localname)
}

ASNavigationRailItemViewImpl *create_ASNavigationRailItemViewImpl_initWithNSString_withNSString_(NSString *groupName, NSString *localname) {
  J2OBJC_CREATE_IMPL(ASNavigationRailItemViewImpl, initWithNSString_withNSString_, groupName, localname)
}

void ASNavigationRailItemViewImpl_setWidgetOnNativeClass(ASNavigationRailItemViewImpl *self) {
  ((ASUIView*) [self asNativeWidget]).widget = self;
}

void ASNavigationRailItemViewImpl_nativeRemoveViewWithASIWidget_(ASNavigationRailItemViewImpl *self, id<ASIWidget> widget) {
  ADLayoutTransition *layoutTransition = [((ADXNavigationRailItemView *) nil_chk(self->navigationRailItemView_)) getLayoutTransition];
  if (layoutTransition != nil && ([layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_CHANGE_DISAPPEARING] || [layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_DISAPPEARING])) {
    [self addToBufferedRunnablesWithJavaLangRunnable:new_ASNavigationRailItemViewImpl_$Lambda$1_initWithASIWidget_(widget)];
  }
  else {
...
void ASNavigationRailItemViewImpl_createLayoutParamsWithADView_(ASNavigationRailItemViewImpl *self, ADView *view) {
...
ADFrameLayout_LayoutParams *ASNavigationRailItemViewImpl_getLayoutParamsWithADView_(ASNavigationRailItemViewImpl *self, ADView *view) {
  return (ADFrameLayout_LayoutParams *) cast_chk([((ADView *) nil_chk(view)) getLayoutParams], [ADFrameLayout_LayoutParams class]);
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ASNavigationRailItemViewImpl)

J2OBJC_NAME_MAPPING(ASNavigationRailItemViewImpl, "com.ashera.navigationview", "AS")

@implementation ASNavigationRailItemViewImpl_NavigationRailItemViewExt
...
- (instancetype)initWithASNavigationRailItemViewImpl:(ASNavigationRailItemViewImpl *)outer$ {
  ASNavigationRailItemViewImpl_NavigationRailItemViewExt_initWithASNavigationRailItemViewImpl_(self, outer$);
  return self;
}
...
- (void)__javaClone:(ASNavigationRailItemViewImpl_NavigationRailItemViewExt *)original {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(initWithASNavigationRailItemViewImpl:);
  ...
  static const void *ptrTable[] = { "setMaxWidth", "I", "setMaxHeight", "LASNavigationRailItemViewImpl;", "onMeasure", "II", "onLayout", "ZIIII", "execute", "LNSString;[LNSObject;", "updateMeasuredDimension", "newInstance", "LASIWidget;", "setAttribute", "LASWidgetAttribute;LNSString;LNSObject;", "()Ljava/util/List<Ljava/lang/String;>;", "getAttribute", "LASWidgetAttribute;", "inflateView", "LNSString;", "getLocationOnScreen", "[I", "getWindowVisibleDisplayFrame", "LADRect;", "offsetTopAndBottom", "offsetLeftAndRight", "setMyAttribute", "LNSString;LNSObject;", "setVisibility", "setState0", "LNSObject;", "setState1", "setState2", "setState3", "setState4", "endViewTransition", "LADView;", "Ljava/util/List<Lcom/ashera/widget/IWidget;>;", "Ljava/util/Map<Ljava/lang/String;Lcom/ashera/widget/IWidget;>;" };
  static const J2ObjcClassInfo _ASNavigationRailItemViewImpl_NavigationRailItemViewExt = { "NavigationRailItemViewExt", "com.ashera.navigationview", ptrTable, methods, fields, 7, 0x1, 38, 7, 3, -1, -1, -1, -1 };
  return &_ASNavigationRailItemViewImpl_NavigationRailItemViewExt;
}

@end

void ASNavigationRailItemViewImpl_NavigationRailItemViewExt_initWithASNavigationRailItemViewImpl_(ASNavigationRailItemViewImpl_NavigationRailItemViewExt *self, ASNavigationRailItemViewImpl *outer$) {
  self->this$0_ = outer$;
...
ASNavigationRailItemViewImpl_NavigationRailItemViewExt *new_ASNavigationRailItemViewImpl_NavigationRailItemViewExt_initWithASNavigationRailItemViewImpl_(ASNavigationRailItemViewImpl *outer$) {
  J2OBJC_NEW_IMPL(ASNavigationRailItemViewImpl_NavigationRailItemViewExt, initWithASNavigationRailItemViewImpl_, outer$)
}

ASNavigationRailItemViewImpl_NavigationRailItemViewExt *create_ASNavigationRailItemViewImpl_NavigationRailItemViewExt_initWithASNavigationRailItemViewImpl_(ASNavigationRailItemViewImpl *outer$) {
  J2OBJC_CREATE_IMPL(ASNavigationRailItemViewImpl_NavigationRailItemViewExt, initWithASNavigationRailItemViewImpl_, outer$)
}
...
void ASNavigationRailItemViewImpl_$Lambda$1_initWithASIWidget_(ASNavigationRailItemViewImpl_$Lambda$1 *self, id<ASIWidget> capture$0) {
  self->val$widget_ = capture$0;
  NSObject_init(self);
}

ASNavigationRailItemViewImpl_$Lambda$1 *new_ASNavigationRailItemViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_NEW_IMPL(ASNavigationRailItemViewImpl_$Lambda$1, initWithASIWidget_, capture$0)
}

ASNavigationRailItemViewImpl_$Lambda$1 *create_ASNavigationRailItemViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_CREATE_IMPL(ASNavigationRailItemViewImpl_$Lambda$1, initWithASIWidget_, capture$0)
}
