...
__attribute__((unused)) static void ASBottomNavigationMenuViewImpl_nativeRemoveViewWithASIWidget_(ASBottomNavigationMenuViewImpl *self, id<ASIWidget> widget);

__attribute__((unused)) static void ASBottomNavigationMenuViewImpl_createLayoutParamsWithADView_(ASBottomNavigationMenuViewImpl *self, ADView *view);

__attribute__((unused)) static ADViewGroup_LayoutParams *ASBottomNavigationMenuViewImpl_getLayoutParamsWithADView_(ASBottomNavigationMenuViewImpl *self, ADView *view);

@interface ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt () {
 @public
  WEAK_ ASBottomNavigationMenuViewImpl *this$0_;
...
J2OBJC_FIELD_SETTER(ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt, measureFinished_, ASMeasureEvent *)
...
J2OBJC_EMPTY_STATIC_INIT(ASBottomNavigationMenuViewImpl_$Lambda$1)

__attribute__((unused)) static void ASBottomNavigationMenuViewImpl_$Lambda$1_initWithASIWidget_(ASBottomNavigationMenuViewImpl_$Lambda$1 *self, id<ASIWidget> capture$0);

__attribute__((unused)) static ASBottomNavigationMenuViewImpl_$Lambda$1 *new_ASBottomNavigationMenuViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ASBottomNavigationMenuViewImpl_$Lambda$1 *create_ASBottomNavigationMenuViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0);


NSString *ASBottomNavigationMenuViewImpl_LOCAL_NAME = @"com.google.android.material.bottomnavigation.BottomNavigationMenuView";
NSString *ASBottomNavigationMenuViewImpl_GROUP_NAME = @"com.google.android.material.bottomnavigation.BottomNavigationMenuView";

@implementation ASBottomNavigationMenuViewImpl
...
- (instancetype)init {
  ASBottomNavigationMenuViewImpl_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (instancetype)initWithNSString:(NSString *)localname {
  ASBottomNavigationMenuViewImpl_initWithNSString_(self, localname);
  return self;
}

- (instancetype)initWithNSString:(NSString *)groupName
                    withNSString:(NSString *)localname {
  ASBottomNavigationMenuViewImpl_initWithNSString_withNSString_(self, groupName, localname);
  return self;
}

- (id<ASIWidget>)newInstance {
  return new_ASBottomNavigationMenuViewImpl_initWithNSString_withNSString_(groupName_, localName_);
}

- (void)createWithASIFragment:(id<ASIFragment>)fragment
              withJavaUtilMap:(id<JavaUtilMap>)params {
  [super createWithASIFragment:fragment withJavaUtilMap:params];
  bottomNavigationMenuView_ = new_ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt_initWithASBottomNavigationMenuViewImpl_(self);
  [self nativeCreateWithJavaUtilMap:params];
  ASViewGroupImpl_registerCommandConveterWithASIWidget_(self);
  ASBottomNavigationMenuViewImpl_setWidgetOnNativeClass(self);
}
...
- (id)asWidget {
  return bottomNavigationMenuView_;
}

- (bool)removeWithASIWidget:(id<ASIWidget>)w {
  bool remove = [super removeWithASIWidget:w];
  [((ADXBottomNavigationMenuView *) nil_chk(bottomNavigationMenuView_)) removeViewWithADView:(ADView *) cast_chk([((id<ASIWidget>) nil_chk(w)) asWidget], [ADView class])];
  ASBottomNavigationMenuViewImpl_nativeRemoveViewWithASIWidget_(self, w);
  return remove;
}
...
- (bool)removeWithInt:(int32_t)index {
  ...
  if (index + 1 <= [((ADXBottomNavigationMenuView *) nil_chk(bottomNavigationMenuView_)) getChildCount]) {
    [((ADXBottomNavigationMenuView *) nil_chk(bottomNavigationMenuView_)) removeViewAtWithInt:index];
    ASBottomNavigationMenuViewImpl_nativeRemoveViewWithASIWidget_(self, widget);
  }
  return remove;
}
...
- (void)addWithASIWidget:(id<ASIWidget>)w
  ...
  if (index != -2) {
    ...
    ASBottomNavigationMenuViewImpl_createLayoutParamsWithADView_(self, view);
    if (index == -1) {
      [((ADXBottomNavigationMenuView *) nil_chk(bottomNavigationMenuView_)) addViewWithADView:view];
    }
    else {
      [((ADXBottomNavigationMenuView *) nil_chk(bottomNavigationMenuView_)) addViewWithADView:view withInt:index];
    }
  }
...
- (ADViewGroup_LayoutParams *)getLayoutParamsWithADView:(ADView *)view {
  return ASBottomNavigationMenuViewImpl_getLayoutParamsWithADView_(self, view);
}
...
- (void)setChildAttributeWithASIWidget:(id<ASIWidget>)w
                 withASWidgetAttribute:(ASWidgetAttribute *)key
                          withNSString:(NSString *)strValue
                                withId:(id)objValue {
  ADView *view = (ADView *) cast_chk([((id<ASIWidget>) nil_chk(w)) asWidget], [ADView class]);
  ADViewGroup_LayoutParams *layoutParams = ASBottomNavigationMenuViewImpl_getLayoutParamsWithADView_(self, view);
...
- (IOSClass *)getViewClass {
  return ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt_class_();
}
...
- (void)setIdWithNSString:(NSString *)id_ {
  if (id_ != nil && ![id_ isEqual:@""]) {
    ...
    [((ADXBottomNavigationMenuView *) nil_chk(bottomNavigationMenuView_)) setIdWithInt:[((JavaLangInteger *) nil_chk((JavaLangInteger *) cast_chk([self quickConvertWithId:id_ withNSString:@"id"], [JavaLangInteger class]))) intValue]];
  }
}
...
void ASBottomNavigationMenuViewImpl_init(ASBottomNavigationMenuViewImpl *self) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, ASBottomNavigationMenuViewImpl_GROUP_NAME, ASBottomNavigationMenuViewImpl_LOCAL_NAME);
}

ASBottomNavigationMenuViewImpl *new_ASBottomNavigationMenuViewImpl_init() {
  J2OBJC_NEW_IMPL(ASBottomNavigationMenuViewImpl, init)
}

ASBottomNavigationMenuViewImpl *create_ASBottomNavigationMenuViewImpl_init() {
  J2OBJC_CREATE_IMPL(ASBottomNavigationMenuViewImpl, init)
}

void ASBottomNavigationMenuViewImpl_initWithNSString_(ASBottomNavigationMenuViewImpl *self, NSString *localname) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, ASBottomNavigationMenuViewImpl_GROUP_NAME, localname);
}

ASBottomNavigationMenuViewImpl *new_ASBottomNavigationMenuViewImpl_initWithNSString_(NSString *localname) {
  J2OBJC_NEW_IMPL(ASBottomNavigationMenuViewImpl, initWithNSString_, localname)
}

ASBottomNavigationMenuViewImpl *create_ASBottomNavigationMenuViewImpl_initWithNSString_(NSString *localname) {
  J2OBJC_CREATE_IMPL(ASBottomNavigationMenuViewImpl, initWithNSString_, localname)
}

void ASBottomNavigationMenuViewImpl_initWithNSString_withNSString_(ASBottomNavigationMenuViewImpl *self, NSString *groupName, NSString *localname) {
  ASBaseHasWidgets_initWithNSString_withNSString_(self, groupName, localname);
}

ASBottomNavigationMenuViewImpl *new_ASBottomNavigationMenuViewImpl_initWithNSString_withNSString_(NSString *groupName, NSString *localname) {
  J2OBJC_NEW_IMPL(ASBottomNavigationMenuViewImpl, initWithNSString_withNSString_, groupName, localname)
}

ASBottomNavigationMenuViewImpl *create_ASBottomNavigationMenuViewImpl_initWithNSString_withNSString_(NSString *groupName, NSString *localname) {
  J2OBJC_CREATE_IMPL(ASBottomNavigationMenuViewImpl, initWithNSString_withNSString_, groupName, localname)
}

void ASBottomNavigationMenuViewImpl_setWidgetOnNativeClass(ASBottomNavigationMenuViewImpl *self) {
  ((ASUIView*) [self asNativeWidget]).widget = self;
}

void ASBottomNavigationMenuViewImpl_nativeRemoveViewWithASIWidget_(ASBottomNavigationMenuViewImpl *self, id<ASIWidget> widget) {
  ADLayoutTransition *layoutTransition = [((ADXBottomNavigationMenuView *) nil_chk(self->bottomNavigationMenuView_)) getLayoutTransition];
  if (layoutTransition != nil && ([layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_CHANGE_DISAPPEARING] || [layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_DISAPPEARING])) {
    [self addToBufferedRunnablesWithJavaLangRunnable:new_ASBottomNavigationMenuViewImpl_$Lambda$1_initWithASIWidget_(widget)];
  }
  else {
...
void ASBottomNavigationMenuViewImpl_createLayoutParamsWithADView_(ASBottomNavigationMenuViewImpl *self, ADView *view) {
...
ADViewGroup_LayoutParams *ASBottomNavigationMenuViewImpl_getLayoutParamsWithADView_(ASBottomNavigationMenuViewImpl *self, ADView *view) {
  return [((ADView *) nil_chk(view)) getLayoutParams];
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ASBottomNavigationMenuViewImpl)

J2OBJC_NAME_MAPPING(ASBottomNavigationMenuViewImpl, "com.ashera.navigationview", "AS")

@implementation ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt
...
- (instancetype)initWithASBottomNavigationMenuViewImpl:(ASBottomNavigationMenuViewImpl *)outer$ {
  ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt_initWithASBottomNavigationMenuViewImpl_(self, outer$);
  return self;
}
...
- (void)__javaClone:(ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt *)original {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(initWithASBottomNavigationMenuViewImpl:);
...
ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt *new_ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt_initWithASBottomNavigationMenuViewImpl_(ASBottomNavigationMenuViewImpl *outer$) {
  J2OBJC_NEW_IMPL(ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt, initWithASBottomNavigationMenuViewImpl_, outer$)
}

ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt *create_ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt_initWithASBottomNavigationMenuViewImpl_(ASBottomNavigationMenuViewImpl *outer$) {
  J2OBJC_CREATE_IMPL(ASBottomNavigationMenuViewImpl_BottomNavigationMenuViewExt, initWithASBottomNavigationMenuViewImpl_, outer$)
}
...
void ASBottomNavigationMenuViewImpl_$Lambda$1_initWithASIWidget_(ASBottomNavigationMenuViewImpl_$Lambda$1 *self, id<ASIWidget> capture$0) {
  self->val$widget_ = capture$0;
  NSObject_init(self);
}

ASBottomNavigationMenuViewImpl_$Lambda$1 *new_ASBottomNavigationMenuViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_NEW_IMPL(ASBottomNavigationMenuViewImpl_$Lambda$1, initWithASIWidget_, capture$0)
}

ASBottomNavigationMenuViewImpl_$Lambda$1 *create_ASBottomNavigationMenuViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_CREATE_IMPL(ASBottomNavigationMenuViewImpl_$Lambda$1, initWithASIWidget_, capture$0)
}
