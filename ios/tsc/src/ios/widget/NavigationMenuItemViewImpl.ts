...
export abstract class NavigationMenuItemViewImpl<T> extends ViewGroupImpl<T>{
	//start - body
	static initialize() {
...
//start - staticinit
export abstract class NavigationMenuItemViewImpl_LayoutParams<T> extends ViewGroupImpl_LayoutParams<T> {
	@decorate(Type(() => CommandAttr))
...
export class NavigationMenuItemView_LayoutParams extends NavigationMenuItemViewImpl_LayoutParams<NavigationMenuItemView_LayoutParams> implements ILayoutParam {
    getThisPointer(): NavigationMenuItemView_LayoutParams {
        return this;
    }
...
export class NavigationMenuItemView extends NavigationMenuItemViewImpl<NavigationMenuItemView> implements IWidget{
    getThisPointer(): NavigationMenuItemView {
        return this;
    }
...
NavigationMenuItemViewImpl.initialize();
